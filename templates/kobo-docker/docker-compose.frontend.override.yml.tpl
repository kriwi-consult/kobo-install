...
services:
  ...
  ${USE_KC_DEV_MODE}    - ${KC_PATH}:/srv/src/kobocat
    ...
    ${USE_FAKE_DNS}  - ${BMIS_SUBDOMAIN}.${PUBLIC_DOMAIN_NAME}:${LOCAL_INTERFACE_IP}
  ...
  bmis:
    ...
    ${USE_BACKEND_NETWORK}  kobo-be-network:
    ${USE_BACKEND_NETWORK}    aliases:
    ${USE_BACKEND_NETWORK}      - bmis
    ${USE_BACKEND_NETWORK}      - bmis.docker.container
    volumes:
      - ../bmis/:/code/
      - ../bmis/static/:/code/static/
  ...
  bmis_worker:
    ...
    ${USE_BACKEND_NETWORK}  kobo-be-network:
    ${USE_BACKEND_NETWORK}    aliases:
    ${USE_BACKEND_NETWORK}      - bmis_worker
    ${USE_BACKEND_NETWORK}      - bmis.docker.container
    ...
    networks:
      kobo-fe-network:
        aliases:
          ...
          - ${BMIS_SUBDOMAIN}.${INTERNAL_DOMAIN_NAME}
